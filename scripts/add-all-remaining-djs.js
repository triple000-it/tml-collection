...
// Complete list of all 120 DJs with proper categorization
const allDjs = [
  // S-Tier: LEGENDARY (The Legends & Architects) - 10 DJs
  {
  ...
  // A-Tier: EPIC (The Modern Titans & Genre Sovereigns) - 4 DJs
  {
  ...
  // B-Tier: RARE (The Elite Stars & Consistent Headliners) - 10 DJs
  {
    stage_name: 'Aly & Fila',
  ...
  // C-Tier: UNCOMMON (The Power Players & Rapid Risers) - 19 DJs
  {
...
async function addAllDjs() {
  try {
    console.log('🔄 Adding all remaining DJs to complete the collection...');
